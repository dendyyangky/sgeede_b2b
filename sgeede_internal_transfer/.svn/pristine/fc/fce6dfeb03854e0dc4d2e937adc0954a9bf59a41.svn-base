...
class stock_picking(osv.osv):
	...
	def do_internal_transfer_details(self, cr, uid, picking, context=None):
		...
		# created_id = self.pool['transfer.details'].create(cr, uid, {'picking_id': len(picking) and picking[0] or False}, context)
		# self.pool['transfer.details'].do_detailed_transfer(cr, uid, created_id)
